...
function App() {
    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-graphite text-white">
      ...
      <section className="relative min-h-screen overflow-hidden px-5 pb-24 pt-28 md:px-8 md:pb-32 md:pt-32">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-12rem)] max-w-5xl flex-col items-center justify-center text-center">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            <Button href="https://wa.me/77761116454?text=Здравствуйте!%0A%0AМеня%20интересует%20пилотный%20проект%20EasyGo.%0A%0AКомпания:%20%0AКонтактное%20лицо:%20%0AДолжность:%20%0AТелефон:%20%0A%0AИнтерес:%20%0A□%20Авиакомпания%0A□%20Маркетплейс%0A□%20Логистическая%20компания%0A□%20Инвестор">
  Запустить пилот
</Button>
  ...
  target="_blank"
  rel="noreferrer"
  className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-sm font-bold text-white shadow-lg transition hover:scale-105 hover:bg-green-600"
>
  WA
</a>
    </main>
